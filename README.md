Tacoteca
Sistema de comercio electrónico para la venta y gestión de pedidos de comida, especializado en tacos al pastor, asada y campechanos. El proyecto cuenta con una arquitectura desacoplada compuesta por una interfaz de usuario en el frontend y una interfaz de programación de aplicaciones en el backend.
